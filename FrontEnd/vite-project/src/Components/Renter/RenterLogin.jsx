...
const RenterLogin = () => {
  ...
  const handleRenterLogin = async (e) => {
    ...
    try {
      const response = await axios.post('http://localhost:5000/api/auth/renter-login', { email, password });
  ...
  return (
    <div className="relative h-full min-h-screen font-[sans-serif]">
      ...
      <div className="relative z-10 flex justify-end items-center h-full p-11 ">
        <div>
          <form onSubmit={handleRenterLogin} className="bg-opacity-90 bg-black rounded-2xl p-6 pl-14 pr-14 mt-12">
            <div className="mb-12">
            ...
            <div className="mt-12">
              ...
              <p className="text-white text-sm text-center mt-6">
                ...
                <a
                  onClick={() => navigate('/renter-signup')}
